namespace ShiftTrack.Application.Features.System.User.Common.Constants;

public static class DefaultRolesDirectory
{
    public const string SYS_ADMIN = "Адміністратор системи";
